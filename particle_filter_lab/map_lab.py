...
class Map:
    ...
    def draw_map(self):
        ...
        for name, object in self.objects.items():
            line1 = [
                [object["upper_right"][0], object["lower_right"][0]],
                [object["upper_right"][1], object["lower_right"][1]],
            ]
            line2 = [
                [object["lower_right"][0], object["lower_left"][0]],
                [object["lower_right"][1], object["lower_left"][1]],
            ]
            line3 = [
                [object["lower_left"][0], object["upper_left"][0]],
                [object["lower_left"][1], object["upper_left"][1]],
            ]
            line4 = [
                [object["upper_left"][0], object["upper_right"][0]],
